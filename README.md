...
Clinical diagnosis still remains challenging to this day. Human error can hinder clinical interpretations due to fatigue, reader inexperience etc. In this project, I built a deep learning classifier using PyTorch to fine-tune a VGG-19 model assisting radiologists in making accurate interpretations.
...
- Data Simulation: A team project involving simulation of data for a cross-regional case-control study of disease X among men.
